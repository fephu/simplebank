...
func TestTransferTx(t *testing.T) {
	...
	updateAccount1, err := testQueries.GetAccount(context.Background(), randomAccount1.ID)
	require.NoError(t, err)

	updateAccount2, err := testQueries.GetAccount(context.Background(), randomAccount2.ID)
	require.NoError(t, err)
